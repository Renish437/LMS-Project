...
@section('content')
    <div class="page-content">
        <!--breadcrumb-->
        @include('backend.section.breadcumb',['title' => 'SubCategories','sub_title' => 'All SubCategories'])
        <!--end breadcrumb-->
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                                ...
                                                aria-label="Age: activate to sort column ascending">Category</th>
                                            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                        ...
                                        @foreach ($subcategories as $key => $subcategory)
                                            <tr role="row" class="odd">
                                                ...
                                                <td class="gap-3">
                                                    ...
                                                    <a  href="javascript:;" data-id="{{ $subcategory->id }}"
                                                        class="btn btn-danger delete-subcategory">
                                                    ...
                                                    <form id="delete-subcategory-form" method="post" class="d-none">
                                                        @csrf
                                                        @method('DELETE')
            ...
            $(document).on('click', '.delete-subcategory', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $('#delete-subcategory-form').attr('action', deleteUrl).submit();
                    }
                });
            });
        </script>
