                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div style="display:flex; align-items:center; justify-content: flex-start; gap: 15px">
                            ...
                            <div>
                                <img src="{{asset($user_info->photo ?? 'backend/assets/images/avatars/avatar-1.png')}}" class="text-center" width="120" height='120' style="border-radius: 60px"  />
                    ...
                    <div class="card-body">
                        ...
                        <div style="display:flex; align-items:center; justify-content: flex-start; gap: 15px">
                            ...
                            <div style="display: flex; flex-direction:column; gap: 10px;">
                                ...
                                <span>Transaction Id: {{$payment_info->transaction_id}}</span>
