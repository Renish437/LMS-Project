...
@section('content')
    <div class="page-content">
        ...
        <!--breadcrumb-->
        @include('backend.section.breadcumb', ['title'=> 'Setting', 'sub_title'=> 'Google-Setting'])
        <!--end breadcrumb-->
            ...
            <div class="card-body">
                ...
                <div class="card-body p-4">
                    ...
                    <form class="row g-3" method="post" action="{{ route('admin.google.settings.update') }}">
                        ...
                        <div class="col-md-12">
                            <label for="redirect_url" class="form-label">GOOGLE_REDIRECT_URL</label>
                            <input type="text" class="form-control" name="redirect_url" id="redirect_url"
                                placeholder="Enter google redirect url"
                                value="{{ old('redirect_url', $google->redirect_url ?? '') }}" required>
                        </div>
