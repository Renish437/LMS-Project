                    ...
                    <form class="row g-3" method="post" action="{{ route('instructor.coupon.store') }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="coupon_name" id="name"
                                placeholder="Enter the coupon name" value="{{ old('coupon_name') }}" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" name="coupon_discount" id="coupon_discount"
                                placeholder="Enter discount price" value="{{ old('coupon_discount') }}" />
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control" name="coupon_validity" id="coupon_validity"
                                placeholder="Enter validity price" value="{{ old('coupon_validity') }}" />
                        </div>
                        <div class="col-md-6">
