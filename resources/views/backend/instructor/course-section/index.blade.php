...
@section('content')
    <div class="page-content">
        <!--breadcrumb-->
        @include('backend.section.breadcumb', ['title' => 'Section', 'sub_title' => 'All Section'])
        <!--end breadcrumb-->
        <div class="row">
                                ...
                                @foreach ($data['lecture'] as $lecture)
                                    <div style="display: flex; align-items:center; justify-content:space-between;">
                                        ...
                                        <div>
                                            ...
                                            <form id="delete-lecture-form" method="POST" style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
        ...
        $(document).on('click', '.delete-lecture', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $('#delete-lecture-form').attr('action', deleteUrl).submit();
                }
            });
        });
    </script>
