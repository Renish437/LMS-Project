        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-3">
                <div class="category-btn-box text-right">
                    <a href="{{ route('front.all-categories') }}" class="btn theme-btn">All Categories <i class="la la-arrow-right icon ml-1"></i></a>
            ...
            <div class="row">
                @foreach ($categories->take(6) as $category)
                    ...
                    <div class="category-item">
                        <img loading="lazy" style="width: 420px; height: 280px"  class="cat__img lazy " src="{{ asset($category->image) }}" data-src="{{ asset($category->image) ?? asset('frontend/images/img2.jpg') }}" alt="Category image">
