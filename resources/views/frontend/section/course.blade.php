<section class="course-area pb-120px">
    <div class="container">
        ...
        <ul class="nav nav-tabs generic-tab justify-content-center pb-4" id="myTab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link {{ $key == 0 ? 'active' : '' }}" id="{{ $value->slug }}-tab" data-toggle="tab"
                    href="#{{ $value->slug }}" role="tab" aria-controls="{{ $value->slug }}"
                    aria-selected="{{ $key == 0 ? 'true' : 'false' }}">{{ $value->name }}</a>
            </li>
            @endforeach
    ...
    <div class="card-content-wrapper bg-gray pt-50px pb-120px">
        <div class="container">
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade show {{ $key == 0 ? ' active' : '' }}" id="{{ $data->slug }}" role="tabpanel"
                            ...
                            <div class="card card-item card-preview"
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title"><a
                                            href="{{ route('course.details', $course->course_name_slug) }}">{{
