        ...
        <div class="row">
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-s text-center">
                    <div class="card-body">
                        <img src="{{ asset('frontend/images/small-img-2.jpg') }}" data-src="{{ asset('frontend/images/small-img-2.jpg') }}" alt="card image" class="img-fluid rounded-full lazy">
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-s text-center">
                    <div class="card-body">
                        <img src="{{ asset('frontend/images/small-img-3.jpg') }}" data-src="{{ asset('frontend/images/small-img-3.jpg') }}" alt="card image" class="img-fluid rounded-full lazy">
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-s text-center">
                    <div class="card-body">
                        <img src="{{ asset('frontend/images/small-img-4.jpg') }}" data-src="{{ asset('frontend/images/small-img-4.jpg') }}" alt="card image" class="img-fluid rounded-full lazy">
                        <h5 class="card-title pt-4 pb-2">EduNexus for Business</h5>
