...
<section class="cart-area section--padding">
    <form method="POST" action="{{ route('order.store') }}" id="checkout-form" class="payment-form">
        @csrf
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
...
@endif
                            ...
                            <div class="row d-inline-flex">
                                ...
                                <div class="input-box col-lg-12">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control form--control" type="text" name="zip_code" placeholder="Postal / Zip code">
                            ...
                            <div class="order-details-lists">
                                @forelse ($carts as $item)
                                    <div class="media media-card border-bottom border-bottom-gray pb-3 mb-3">
                                        ...
                                        <input type="hidden" name="course_name[]" value="{{ $item->course->course_title }}">
                                        ...
                                        <input type="hidden" name="course_price[]" value="{{ $item->course->discount_price }}">
