            ...
            <div class="col-lg-7">
                <div class="card card-item">
                    <div class="card-body">
                        ...
                        @endif
                        <div class="divider"><span></span></div>
                        <form method="post" class="row d-inline-flex ">
                            <div class="input-box col-lg-6">
                                <label class="label-text">First Name</label>
                                <div class="form-group">
                            ...
                            <div class="media media-card border-bottom border-bottom-gray pb-3 mb-3">
                                ...
                                <div class="media-body">
                                    <h5 class="fs-15 pb-2"><a
                                            href="{{ route('course.details', $item->course->course_name_slug) }}">{{
                                            $item->course->course_title }}</a></h5>
                                    <p class="text-black font-weight-semi-bold lh-18">${{ $item->course->discount_price
                                        }} <span class="before-price fs-14">${{ $item->course->selling_price }}</span>
                                    </p>
                                </div>
                            </div><!-- end media -->
                            @empty
                ...
                <div class="card card-item">
                    <div class="card-body">
                        ...
                        <div class="btn-box border-top border-top-gray pt-3">
                            ...
                            <button onclick="event.preventDefault(); document.getElementById('checkout-form').submit();"
                                class="btn theme-btn w-100">Proceed <i class="la la-arrow-right icon ml-1"></i></button>
                        </div>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-5 -->
