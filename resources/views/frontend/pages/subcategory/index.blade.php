...
================================= -->
@include('frontend.section.breadcrumb', ['title' => 'Subcategory', 'sub_title' => "All $slug->name"])
<!-- ================================
    END BREADCRUMB AREA
================================= -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <p class="card-price text-black font-weight-bold">${{ $item->discount_price }} <span class="before-price font-weight-medium">{{ $item->selling_price }}</span></p>
                              <div data-course-id="{{ $item->id }}" class="icon-element icon-element-sm shadow-sm cursor-pointer wishlist-icon"
