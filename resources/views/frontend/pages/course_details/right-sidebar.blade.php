 <div class="sidebar sidebar-negative">
                   @include('frontend.pages.course_details.rightside-course-preview')



                    @include('frontend.pages.course_details.rightside-course-featured')
                   @include('frontend.pages.course_details.rightside-course-category')
                  @include('frontend.pages.course_details.rightside-related-courses')
