                            ...
                            <div class="preview-course-feature-content pt-40px">
                                ...
                                <div class="preview-course-incentives">
                                    ...
                                    <ul class="generic-list-item pb-3">
                                        <li><i class="la la-play-circle-o mr-2 text-color"></i>{{ $total_hours }} hours on-demand video</li>
                                        ...
                                        <li><i class="la la-certificate mr-2 text-color"></i>{{ $course->certificate ? 'Certificate of Completion' : 'No Certificate of Completion' }}</li>
                                    </ul>
                                    <div class="section-block"></div>
                                    <div class="buy-for-team-container pt-4">
                                        <h3 class="fs-18 font-weight-semi-bold pb-2">Training 5 or more people?</h3>
                                        <p class="lh-24 pb-3">Get your team access to 3,000+ top EduNexus courses anytime, anywhere.</p>
                                        <a href="for-business.html" class="btn theme-btn theme-btn-sm theme-btn-transparent lh-30 w-100">Try EduNexus for Business</a>
                                    </div>
