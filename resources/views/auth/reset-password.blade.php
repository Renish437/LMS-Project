                ...
                <div class="card card-item">
                    <div class="card-body">
                        ...
                        <p class="fs-15 lh-24 pb-3">Enter the email of your account to reset password. Then you will
                            receive a link to email to reset the password.If you have any issue about reset password <a href="{{ url('/') }}" class="text-color hover-underline">contact us</a></p>
        ...
        <input type="hidden" name="token" value="{{ $request->route('token') }}">
                            ...
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="text" name="email" value="{{ old('email', $request->email) }}" placeholder="Enter email Address">
